      ...
      <div className="container px-9 w-full sm:w-2/3 lg:1/2 md:flex">
        <div className="flex flex-1 flex-col">
          ...
          <p className="mt-4 mb-6 text-lg">
            ...
            monitoring. I'm quietly confident, always seeking a challenge, and
            constantly working to improve and grow my skills and knowledge.
          </p>
      ...
      <div className="container px-9 w-full flex flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:grid-cols-3">
          {portfolioData.projects
            .slice()
            .reverse()
            .map(({ title, description, banner }, i) => {
              return (
                <a
                  key={`portfolio-${i}`}
