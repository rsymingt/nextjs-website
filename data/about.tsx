    ...
    'Main Skills': [
      {
        ...
        short: 'NodeJS (Express) | Python | GoLang | C# (.NET Core)',
        description: 'Design/Develop Restful APIs and services',
      },
      {
        title: 'Frontend Development',
        short: 'React | NextJS | TailwindCSS | Bootstrap',
        description: 'Implement interactive and asynchronous UI',
      },
      {
        title: 'Microservices Development',
        short: 'Design | Iteration',
        description:
          'Breaking down monolithic services or ideas into microservices',
      },
    ],
    // "Projects & Awards": [
    //     {
